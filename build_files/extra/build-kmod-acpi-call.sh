...
cp /tmp/ublue-os-akmods-addons/rpmbuild/SOURCES/_copr_cr7pt0gr4ph7-acpi_call.repo /etc/yum.repos.d/
...
rm -f /etc/yum.repos.d/_copr_cr7pt0gr4ph7-acpi_call.repo
